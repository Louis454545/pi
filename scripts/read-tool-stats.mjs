...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".morgan/agent/sessions");
const DEFAULT_ACTIVE_READ_TOOL_PATH = path.join(process.cwd(), "packages/morgan-agent/src/core/tools/read.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.morgan/agent/sessions)
