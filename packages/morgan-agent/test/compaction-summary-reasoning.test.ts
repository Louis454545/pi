...
import type { AssistantMessage, Model } from "@earendil-works/morgan-ai";
...
vi.mock("@earendil-works/morgan-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/morgan-ai")>();
	return {
		...actual,
