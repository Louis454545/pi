...
describe("normalizeChangelogLinks", () => {
	test("rewrites package-relative changelog links to tag-pinned GitHub source links", () => {
		...
		expect(normalizeChangelogLinks(markdown, entry)).toBe(
			[
				"[Project Trust](https://github.com/earendil-works/morgan/blob/v0.79.0/packages/morgan-agent/README.md#project-trust)",
				"[Extensions](https://github.com/earendil-works/morgan/blob/v0.79.0/packages/morgan-agent/docs/extensions.md#project_trust)",
	...
	test("canonicalizes old repository URLs without changing external links", () => {
		const markdown = [
			"[#5167](https://github.com/earendil-works/morgan-mono/pull/5167)",
		...
		expect(normalizeChangelogLinks(markdown, "0.79.0")).toBe(
			[
				...
				"[#4163](https://github.com/earendil-works/morgan/issues/4163)",
