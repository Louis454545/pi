...
import { discoverAndLoadExtensions as loadDiscoveredExtensions } from "../src/core/extensions/loader.ts";
...
describe("Input Event", () => {
	...
	beforeEach(() => {
		tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "morgan-input-test-"));
