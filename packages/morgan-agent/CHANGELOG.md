...
- Strengthened agent guidance to reuse existing capabilities, complete ordinary human-delegated work, preserve contextual model judgment in automations, factor costly repeated work, prefer quiet event-driven monitoring, and maintain contextually valuable proactive information and reminders.
...
- Fixed `morgan daemon attach` to open a daemon-backed TUI instead of the line-based prompt client.
