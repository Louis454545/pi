 ...
 * working indicator shown while morgan is streaming a response.
 *
 * Usage:
 *   morgan --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore morgan's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@earendil-works/morgan-agent";
...
export default function (morgan: ExtensionAPI) {
	...
	morgan.registerCommand("working-indicator", {
