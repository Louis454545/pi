 ...
 *   cd packages/morgan-agent/examples/extensions/custom-provider && npm install
 *
 *   # With OAuth (run /login custom-anthropic first)
 *   morgan -e ./packages/morgan-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... morgan -e ./packages/morgan-agent/examples/extensions/custom-provider
 *
...
export default function (morgan: ExtensionAPI) {
	morgan.registerProvider("custom-anthropic", {
