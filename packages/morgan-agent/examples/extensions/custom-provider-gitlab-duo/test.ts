...
import { type Api, type Context, type Model, registerApiProvider, streamSimple } from "@earendil-works/morgan-ai";
import { readFileSync } from "fs";
import { getAgentDir } from "packages/morgan-agent/src/config.js";
