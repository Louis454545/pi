 ...
 * Delegates to morgan-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   morgan -e ./packages/morgan-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (morgan: ExtensionAPI) {
	morgan.registerProvider("gitlab-duo", {
