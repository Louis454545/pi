import type { ExtensionAPI, ExtensionCommandContext } from "@earendil-works/morgan-agent";
import { DynamicBorder, getMarkdownTheme } from "@earendil-works/morgan-agent";
import { complete, getModel } from "@earendil-works/morgan-ai";
import { Container, Markdown, matchesKey, Text } from "@earendil-works/morgan-tui";
...
export default function (morgan: ExtensionAPI) {
	morgan.registerCommand("summarize", {
