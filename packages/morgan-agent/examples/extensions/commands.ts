 ...
 * Commands Extension
 *
 * Demonstrates the morgan.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@earendil-works/morgan-agent";

export default function commandsExtension(morgan: ExtensionAPI) {
	morgan.registerCommand("commands", {
