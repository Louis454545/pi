 ...
 * - Routing tool calls to remote systems (e.g., morgan-ssh-remote)
...
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@earendil-works/morgan-agent";
...
export default function (morgan: ExtensionAPI) {
	...
	morgan.registerCommand("read-log", {
