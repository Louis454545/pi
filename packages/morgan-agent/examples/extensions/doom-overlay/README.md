...
Play DOOM as an overlay in morgan. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
morgan --extension ./examples/extensions/doom-overlay
```
...
- [morgan-doom](https://github.com/badlogic/morgan-doom) for the original morgan integration
