#!/usr/bin/env bash
# Build DOOM for morgan-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_morgan.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
