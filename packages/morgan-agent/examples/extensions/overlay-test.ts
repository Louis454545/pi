 ...
 *
 * Usage: morgan --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@earendil-works/morgan-tui";

export default function (morgan: ExtensionAPI) {
	morgan.registerCommand("overlay-test", {
