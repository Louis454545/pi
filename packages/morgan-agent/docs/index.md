...
Authenticate with `/login` for subscription providers, or set an API key such as `ANTHROPIC_API_KEY` before starting morgan.
...
- [Using Morgan](usage.md) - interactive mode, slash commands, context files, and CLI reference.
...
- [SDK](sdk.md) - embed morgan in Node.js applications.
