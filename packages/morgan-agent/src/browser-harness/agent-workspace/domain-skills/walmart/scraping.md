    ...
    for stack in sr.get("itemStacks", []):
        for item in stack.get("items", []):
            ...
            items.append({
                ...
                "linePrice":       morgan.get("linePrice"),            # str "$429.00"
                "wasPrice":        morgan.get("wasPrice") or None,     # str "$699.00" or None
                "savings":         morgan.get("savings") or None,      # str "SAVE $270.00" or None
...
def extract_product_detail(html):
    ...
    morgan = product.get("priceInfo") or {}
    cp = morgan.get("currentPrice") or {}
    ...
    return {
        ...
        "wasPrice":            (morgan.get("wasPrice") or {}).get("priceString"),
        "savings":             (morgan.get("savings") or {}).get("savingsString"),
        # availability
        "availability":        avail.get("value"),         # "IN_STOCK" / "OUT_OF_STOCK"
