...
import { Container, Text, truncateToWidth } from "@earendil-works/morgan-tui";
...
/**
 * Create bash operations using morgan's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want morgan's
...
export function createBashToolDefinition(
	...
	return {
		...
		async execute(
			...
			const output = new OutputAccumulator({ tempFilePrefix: "morgan-bash" });
