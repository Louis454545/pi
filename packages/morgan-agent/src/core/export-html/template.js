    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="morgan-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="morgan-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'morgan-share:v1:sidebar-width';
