...
declare module "@earendil-works/morgan-tui" {
...
export const KEYBINDINGS = {
	...
	"app.session.new": { defaultKeys: [], description: "Archive and reset the global conversation" },
	"app.session.tree": { defaultKeys: [], description: "Open conversation tree" },
	"app.session.fork": { defaultKeys: [], description: "Advanced fork compatibility action" },
	"app.session.resume": { defaultKeys: [], description: "Advanced switch compatibility action" },
	"app.tree.foldOrUp": {
