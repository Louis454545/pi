...
export interface AgentSessionConfig {
	...
	cwd: string;
	/** Global config directory. Used to derive Morgan's global home for identity and memory. */
	agentDir?: string;
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via morgan.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via morgan.sendMessage()
