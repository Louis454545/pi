...
import type { AgentMessage, StreamFn } from "@earendil-works/morgan-agent-core";
import type { Model, SimpleStreamOptions } from "@earendil-works/morgan-ai";
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from morgan-generated summaries (fromHook !== true), not extension-generated ones
