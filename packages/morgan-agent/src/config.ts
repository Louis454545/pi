...
export function getPackageDir(): string {
	...
	const envDir = process.env.MORGAN_PACKAGE_DIR;
	if (envDir) {
...
const morganConfigName: string | undefined = pkg.morganConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@earendil-works/morgan-agent";
export const APP_NAME: string = morganConfigName || "morgan";
export const APP_TITLE: string = morganConfigName ? APP_NAME : "Morgan";
export const CONFIG_DIR_NAME: string = pkg.morganConfig?.configDir || ".morgan";
...
// =============================================================================
// User Config Paths (~/.morgan/agent/*) and Global Morgan Home (~/.morgan/*)
// =============================================================================

/** Get Morgan's global home directory (e.g., ~/.morgan/). */
export function getMorganHomeDir(agentDir: string = getAgentDir()): string {
...
/** Get the agent config directory (e.g., ~/.morgan/agent/) */
...
export function getSessionsDir(agentDir: string = getAgentDir(), sessionDir?: string): string {
	return sessionDir ? normalizePath(sessionDir) : join(getMorganHomeDir(agentDir), "sessions");
}
