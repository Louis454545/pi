import { ProcessTerminal, setKeybindings, TUI } from "@earendil-works/morgan-tui";
...
const OFFICIAL_PACKAGE_NAME = "@earendil-works/morgan-agent";
const OFFICIAL_APP_NAME = "morgan";
const OFFICIAL_CONFIG_DIR_NAME = ".morgan";
 ...
 * - this is the official Morgan distribution (not a fork/rebrand)
 * - experimental features are enabled (MORGAN_EXPERIMENTAL=1)
