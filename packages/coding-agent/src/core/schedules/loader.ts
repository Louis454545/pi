...
const VIRTUAL_MODULES: Record<string, unknown> = {
	"@earendil-works/pi-coding-agent/schedules": bundledSchedulesApi,
	"@mariozechner/pi-coding-agent/schedules": bundledSchedulesApi,
};
...
function getAliases(): Record<string, string> {
	...
	aliases = {
		"@earendil-works/pi-coding-agent/schedules": schedulesEntry,
		"@mariozechner/pi-coding-agent/schedules": schedulesEntry,
	};
