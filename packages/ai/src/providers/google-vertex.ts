...
import type {
	...
	Context,
	Model,
	ThinkingLevel as MorganThinkingLevel,
	SimpleStreamOptions,
	StreamFunction,
	StreamOptions,
	TextContent,
...
type ClampedThinkingLevel = Exclude<MorganThinkingLevel, "xhigh">;
...
function getDisabledThinkingConfig(model: Model<"google-vertex">): ThinkingConfig {
	...
	// thinkingLevel without includeThoughts so hidden thinking remains invisible to morgan.
	const geminiModel = model as unknown as Model<"google-generative-ai">;
