...
description: Checklist for adding a new LLM provider to packages/ai. Covers core types, provider implementation, lazy registration, model generation, the full test matrix, morgan-agent wiring, and docs.
---
...
## 6. Morgan Agent (`packages/morgan-agent/`)
